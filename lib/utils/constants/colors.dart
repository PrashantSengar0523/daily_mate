...
class TColors {
  // App theme colors
static const Color primary = Colors.green;   // Indigo
static const Color secondary = Colors.deepOrange; // Deep Orange
static const Color accent = Color(0xFF3949AB);    // Darker Green
  ...
  // Button colors
  static const Color buttonPrimary = Color(0xFF3949AB);
